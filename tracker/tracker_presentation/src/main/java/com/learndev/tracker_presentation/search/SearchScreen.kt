...
import com.learndev.tracker_domain.model.MealType
import com.learndev.tracker_presentation.R
import com.learndev.tracker_presentation.search.components.SearchTextField
import com.learndev.tracker_presentation.search.components.TrackableFoodItem
...
fun SearchScreen(
    ...
    {
        Text(text = stringResource(id = R.string.add_meal, mealName))
